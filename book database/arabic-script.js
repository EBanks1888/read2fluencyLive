...
const arabicBooks = books.filter(book => book.language === 'ar');
...
function renderBooks(bookList) {
  if (!bookList.length) {
    bookGrid.innerHTML = '';
    emptyState.textContent = 'No Arabic graded readers match the selected filters. Try changing the level or genre.';
